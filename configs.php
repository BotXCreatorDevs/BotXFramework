...
$botinfo = [
	# 0. id				[Int]
	'id'			=> 123456789,
	# 1. Name			[Text: the bot name]
	'name'			=> 'Test Bot',
	# 2. Username		[Text: the bot username]
	'username'		=> 'TestBot',
	# 3. Telegram settings	[JSON encoded: a list of bot settings]
	'tg_settings'	=> json_encode([
		# Settings update time				[Int]
		'update_time'					=> time(),
		# Supports groups					[Bool]
		'can_join_groups'				=> false,
		# Supports inline mode				[Bool]
		'supports_inline_queries'		=> false,
		# Privacy on groups					[Bool]
		'can_read_all_group_messages'	=> false
	]),
	# 4. Commands of the Bot	[JSON encoded: a list of commands in languages & scopes]
	...
	# 5. Refistration time		[Int]
	'reg_time'		=> time(),
	# 6. Owner Telegram ID		[Int]
	'owner'			=> 244432022,
	# 7. Bot X ID				[Int]
	'botx_id'		=> 1
];

# Bot X Creator configurations [Not needed]
$botxconf = [];
